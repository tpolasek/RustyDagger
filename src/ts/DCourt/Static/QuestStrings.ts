/*
 * Ported from DCourt/Static/QuestStrings.java (Java interface QuestStrings).
 */

export const riddle: string[] = [
...
export const controlled: (string | null)[] = [
  null,
 ...
 * (e.g. `QuestStrings.riddle`).
 */
export const QuestStrings = {
  riddle, answer, guess, seduces, controls, controlled
};

// Compile-time guard: every named export above must appear in the object below.
const _allExports: Omit<typeof import('./QuestStrings'), 'QuestStrings'> = QuestStrings;
void _allExports;
