/*
 * Ported from DCourt/Static/Rumors.java (Java interface Rumors).
 */

export const boardName: string = "board.doc";
...
const _allExports: Omit<typeof import('./Rumors'), 'Rumors'> = Rumors;
void _allExports;
